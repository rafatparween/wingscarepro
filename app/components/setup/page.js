...
//         <div className="bg-transparent text-white w-full max-w-5xl p-10">
//           {/* Title Section */}
//           <h1 className="text-4xl font-semibold text-center mb-4">Complete setup using Professionals Help</h1>
//           <div className="border-t border-white w-32 mx-auto mb-8"></div>
...
//                 <p className="text-lg mt-2">Make sure that your printer is powered on</p>
//               </div>
//               {/* Step 2 */}
//               <div className="flex items-start space-x-3">
//                 <span className="text-5xl font-bold">2</span>
//                 <p className="text-lg mt-2">Complete guide for your printer</p>
//               </div>
  
//               {/* Button */}
//               <button className="mt-8 bg-white text-blue-700 py-2 px-6 rounded-lg font-bold shadow-md hover:bg-gray-100 transition duration-300">
...
//               <img
//                 src="/printer-stack.png" // Place your printer image in the public folder
//                 alt="Printers"
//                 className="h-40 object-contain"
//               />
//               <p className="absolute bottom-2 right-2 text-sm text-white">OTHER PRINTERS</p>
//             </div>
//           </div>
//         </div>
//       </div>
...
function Printersearch() {
  return (
    <div className="h-[530px] mt-[80px]">
      ...
      {/* Additional content */}
      <h1 className="text-[18px] w-[832px] h-[51px] ml-[369px] mt-[100px]">
        Install Smart driver and drivers on each mobile device or computer that you want to print from. Add the printer on the new device.
      </h1>
      <h1 className="mt-[30px] ml-[369px]">
        Need additional help with set-up? Visit <span className="text-[#007DBA]">Support</span>
      </h1>
    </div>
  );
}
